...
<Accordion className="accordion accordion-flush" id="accordionFlushExample" defaultActiveKey="0" flush>
        ...
        <Accordion.Item eventKey='1'>
            ...
            <Accordion.Body>
                ...
                This is the second item's accordion body. Let's imagine this being filled
...
export const accordion11 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
 <p className="mb-0">
    ...
    <Button variant='danger' className="m-1" type="button" data-bs-toggle="collapse" onClick={() => { both(); }}
        ...
        aria-controls=" multiCollapseExample2">Toggle both elements</Button>
</p>
<Row>
...
<p>
  <Button variant='primary' className="" type="button" data-bs-toggle="collapse" onClick={() => setOpen(!open)} aria-controls="example-collapse-text" aria-expanded={open}
      data-bs-target="#collapseWidthExample" >Toggle width collapse
  </Button>
</p>
<div style={{ minHeight: "120px" }}>
  <Collapse in={open} dimension="width">
      <div id="example-collapse-text">
          <Card body style={{ width: "230px" }}>This is some placeholder content for a horizontal collapse. It's hidden by default and shown when triggered.
          </Card>
      </div>
  </Collapse>
</div>
...
export const carousel1=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
export const carousel2=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
// End Prism Code//;
`
export const carousel3=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
// End Prism Code//;
`
export const carousel4=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
// End Prism Code//;
`
export const carousel5=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
// End Prism Code//;
`
export const carousel6=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
// End Prism Code//;
`
export const carousel7=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
// End Prism Code//;
`
export const carousel8=`//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Carousel id="carouselExampleSlidesOnly" className="carousel slide carousel-icons" indicators={false}>
<Carousel.Item className="active">
    <img src="../../../assets/images/media/media-26.jpg" className="d-block w-100" alt="..." />
</Carousel.Item>
...
<Modal show={show} onHide={handleClose} className="fade" id="exampleModal"
...
export const modal3 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Button variant='outline-primary' type="button" onClick={handleShow2}> Scrolling long content
  </Button>
  <Modal show={show2} onHide={handleClose2} keyboard={false}>
      ...
      <Modal.Footer>
          <Button variant='secondary' type="button" className=""
           onClick={handleClose2}>Close</Button>
...
<Modal centered show={modalShow} onHide={() => setModalShow(false)}
 keyboard={false} className="modal fade">
  ...
  <Modal.Footer>
      <Button variant='secondary' type="button" className="btn" 
...
<Button variant='outline-primary' type="button" data-bs-toggle="modal" onClick={handleShow3}>
  ...
  <Modal show={show3} onHide={handleClose3} centered className='popover-modal' id="exampleModalScrollable4" 
   aria-labelledby="exampleModalScrollable4" data-bs-keyboard="false"
      ...
      <Modal.Body>
          ...
          <OverlayTrigger placement="top" overlay={<Tooltip>tooltip</Tooltip>}>
              <Link href="#!" className="text-primary">This link</Link>
          </OverlayTrigger> and <OverlayTrigger placement="top" overlay={<Tooltip>tooltip</Tooltip>}>
              <Link href="#!" className="text-primary">that link</Link>
          </OverlayTrigger> have tooltips on hover.
          </p>
      </Modal.Body>
      <Modal.Footer>
          <Button variant='' type="button" className="btn btn-outline-secondary" 
...
<Modal show={modalShow2} onHide={() => setModalShow2(false)} centered>
    ...
    <Modal.Footer>
      ...
      className="" onClick={() => setModalShow2(false)}
          data-bs-dismiss="modal">Close</Button>
...
<Button variant="outline-primary" data-bs-toggle="modal" onClick={handleShowt1}>Open first modal
</Button>
...
<Modal id="m2" className='fade' aria-labelledby="contained-modal-title-vcenter"
    ...
    <Modal.Footer>
        <Button variant='' className="btn btn-outline-primary" 
        data-bs-target="#exampleModalToggle" onClick={Handleclose2}
...
export const modal9 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Button variant='outline-primary' type="button" className="mb-1 me-2" 
  data-bs-toggle="modal" onClick={() => setXlShow(true)}
...
<Button variant='outline-primary' type="button" className="mb-1 me-2" 
 data-bs-toggle="modal" onClick={() => setSmShow(true)}
...
<Button variant='secondary' type="button" className="btn mb-1 me-2" 
onClick={handleShow5}>Open modal for
    @fat</Button>
...
export const modal12 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Row className="row-sm">
  <Col sm={6} md={4} xl={3} className="col-sm-6 col-md-4 col-xl-3">
      <Link href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" 
      onClick={() => viewDemoShow1("Basic")}>Zoom</Link>
...
<Button variant='primary' className="" type="button" data-bs-toggle="offcanvas" onClick={handleShow1}
  ...
  <Offcanvas show={show1} onHide={handleClose1} backdrop={false}
    className="offcanvas offcanvas-start" data-bs-scroll="true"
...
<Button className="btn btn-primary" type="button" data-bs-toggle="offcanvas" onClick={handleShow3}
    ...
    backdrop</Button>
<Offcanvas show={show3} onHide={handleClose3} backdrop={true} 
...
export const offcanvas5 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
 <Button variant='primary' className="m-1" type="button" data-bs-toggle="offcanvas" onClick={handleShowt}
      ...
      offcanvas</Button>
  <Offcanvas placement='top' show={showt} onHide={handleCloset} 
  className="offcanvas-top" tabindex="-1" id="offcanvasTop"
...
export const placeholder1=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
export const placeholder2=`//<!-- Prism Code: This code is only used for showcode purpose -->//
...
export const placeholder3=`//<!-- Prism Code: This code is only used for showcode purpose -->//
<span className="placeholder col-12"></span>
...
export const placeholder4=`//<!-- Prism Code: This code is only used for showcode purpose -->//
