...
export const SocialIconButtons= [
	{ id: 1, class: "facebook" , icon:'facebook'},
	{ id: 2, class: "twitter" , icon:'twitter-x'},
	{ id: 3, class: "instagram" , icon:'instagram'},
	{ id: 4, class: "github" , icon:'github'},
	{ id: 5, class: "youtube" , icon:'youtube'},
	{ id: 5, class: "google" , icon:'google'},
