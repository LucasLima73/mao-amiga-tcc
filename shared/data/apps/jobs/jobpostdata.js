  ...
  export const jobpost3 = [
    { value: 'Normal', label: 'Normal' },
    { value: 'Urgent', label: 'Urgent' }
  ];

  export const jobpost4 = [
    { value: '10', label: '10' },
    { value: '20', label: '20' },
    { value: '30', label: '30' },
    { value: '40', label: '40' }
