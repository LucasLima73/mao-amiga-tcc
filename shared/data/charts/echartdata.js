...
export function Stackedline() {
    const option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(215, 124, 247)", "rgb(244, 167, 66)", "rgb(12, 163, 231)", "rgb(254, 84, 84)"]
    }
...
export function Steplineechart() {
    const option = {
        ...
        color: [ "rgb(84, 109, 254)", "#23b7e5", "#f5b849", "#49b6f5", "#e6533c"]
    }
...
export function Barwithlabels() {
    const option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(215, 124, 247)", "rgb(244, 167, 66)", "rgb(254, 84, 84)"]
    }
...
export function Horizontalstackechart() {
    const option = {
        ...
        color: ["rgb(84, 109, 254)", "rgb(215, 124, 247)", "rgb(244, 167, 66)", "rgb(254, 84, 84)", "rgb(12, 163, 231)"]
    }
