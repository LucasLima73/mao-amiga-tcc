...
export const Linechartwithlabels ={
    series: [
        {
            name: "High - 2013",
...
export class Brushchart extends Component {
    ...
    render() {
        return (
            <div id="wrapper">
                <div id="brush-chart1">
                    <ReactApexChart options={this.state.options} series={this.state.series} type="line" width={"100%"} height={200} />
                </div>
                <div id="brush-chart">
...
export const Missingnullvalues = {
    series: [{
        name: 'Peter',
